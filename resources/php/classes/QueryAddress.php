...
//print($_sql);
		    ...
		    case "SearchCitizen":
		     $_sql_total=null; 
			  $_sql= 'SELECT t1.`raion_id`, t2.`house`,t1.`address_id`,t1.`address`,t1.`fio` as owner ,t1.`nanim`  FROM YIS.APPARTMENT as t1,YIS.HOUSE as t2 WHERE t2.house_id = t1.house_id and  t1.`raion_id` in(1,2,3,4,5,6,7,11,12)'; 
//print($_sql);
		    break;
		    case "Appartment":
			  $_sql_total=null; 
