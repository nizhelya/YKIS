 ...
 * Date: Thu May 27 2021 01:04:45 GMT+0300 (EEST)
 *
...
Ext.define('Ykis.controller.AppNach', {
    ...
    control: {
        ...
        "#grMsgVik": {
            selectionchange: 'onGrMsgVikSelectionChange'
        },
        "#grLgotaNachVoda": {
    ...
    onGrMsgVikSelectionChange: function(model, selected, eOpts) {

        var form = Ext.getCmp('tabFmAppVik');
        var html = Ext.getCmp('cntMsgVik');

        if (selected.length > 0) {
            html.update(selected[0].data.msg);
