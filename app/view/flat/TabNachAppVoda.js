 ...
 * Date: Sat Jun 05 2021 10:38:18 GMT+0300 (EEST)
 *
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            height: 415,
                            layout: 'absolute',
                            title: 'Повідомлення про заборгованості',
                            items: [
                                {
                                    xtype: 'button',
                                    handler: function(button, event) {
                                        ...
                                        var reppan = Ext.getCmp('cntMsgVik');


                                        QueryReport.getResults(params,function(results){
                                            if (results.success==="1"){
                                                reppan.update(results.content);

                                            }else{
                                                Ext.MessageBox.show({title: "Повідомлення про заборгованості",
                                                    msg: results.msg,
                                                    buttons: Ext.MessageBox.OK,
                                                    icon: Ext.MessageBox.ERROR
                                                });
                                ...
                                },
                                {
                                    ...
                                    handler: function(button, event) {
                                        ...
                                        var login = pvalues.get('login');
                                        var password = pvalues.get('password');
                                        var address_id = pvalues.get('address_id');


                                        var StMsg = Ext.data.StoreManager.get("StMsg");
                                        var html = Ext.getCmp('cntMsgVik');
                                        ...
                                        QueryAddress.updateRecords(params,function(result){
                                            ...
                                            if (result.success){
                                                ...
                                                Ext.MessageBox.show({
                                                    title: 'Повідомлення про заборгованості',
                                                    msg: 'Повідомлення не відправлено',
                                                    buttonText:{
                                                        ok: "Закрити!"
                                                    },
                                                    icon: Ext.MessageBox.WARNING
                                ...
                                },
                                {
                                    ...
                                    x: 270,
                                    y: 40,
                                    html: '<h2 class="msg-confirm">ПОВІДОМЛЕННЯ-ПРЕТЕНЗІЯ </h2>',
                                    padding: 5,
                                    style: 'background-color: #F1EEEE;',
                                    layout: 'absolute'
                                }
